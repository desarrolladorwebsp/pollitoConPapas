...
export function WhatsAppFloatButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-warm transition-transform hover:scale-105"
    >
      <svg width="28" height="28" viewBox="0 0 33 33" fill="currentColor" aria-hidden="true">
